const PATHS = {
  ...
  assets: '<path d="M4 8h16v12H4z"/><path d="M8 8V5h8v3M4 12h16M9 12v2h6v-2"/>',
  missions: '<path d="M6 4h12v17H6z"/><path d="M9 4V2h6v2M9 9l2 2 4-4M9 16h6"/>',
  features: '<path d="m12 3 1.5 5.5L19 10l-5.5 1.5L12 17l-1.5-5.5L5 10l5.5-1.5L12 3Z"/><circle cx="19" cy="19" r="2"/>',
  tools: '<path d="M14 6a5 5 0 0 0-6 6L3 17l4 4 5-5a5 5 0 0 0 6-6l-3 3-4-4 3-3Z"/>',
  support: '<path d="M4 13a8 8 0 0 1 16 0v5h-3v-5h3M4 13v5h3v-5H4Z"/><path d="M17 20h-4"/>',
  settings: '<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-2.8 2.8-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6v.2h-4V21a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1L4.2 17l.1-.1a1.7 1.7 0 0 0 .3-1.9A1.7 1.7 0 0 0 3 14H2.8v-4H3a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9L4.2 7 7 4.2l.1.1a1.7 1.7 0 0 0 1.9.3A1.7 1.7 0 0 0 10 3V2.8h4V3a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1L19.8 7l-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1h.2v4H21a1.7 1.7 0 0 0-1.6 1Z"/>',
  pulse: '<path d="M3 12h4l2-5 4 10 2-5h6"/>',
  group: '<circle cx="8" cy="9" r="3"/><circle cx="17" cy="8" r="2.5"/><path d="M2 20a6 6 0 0 1 12 0M13 14a5 5 0 0 1 8 4"/>',
  shield: '<path d="M12 3 20 6v6c0 5-3.5 8-8 10-4.5-2-8-5-8-10V6l8-3Z"/><path d="m9 12 2 2 4-5"/>',
  weather: '<circle cx="9" cy="9" r="4"/><path d="M9 2v2m0 10v2M2 9h2m10 0h2M4 4l1.5 1.5M14 14l1.5 1.5M16 4l-1.5 1.5"/><path d="M8 20h10a3 3 0 0 0 0-6 5 5 0 0 0-9-1"/>',
  trophy: '<path d="M8 4h8v5a4 4 0 0 1-8 0V4Z"/><path d="M8 6H4v2a4 4 0 0 0 4 4m8-6h4v2a4 4 0 0 1-4 4M12 13v5m-4 3h8m-7-3h6"/>',
  orders: '<path d="M6 3h12v18H6z"/><path d="M9 8h6m-6 4h6m-6 4h4"/>',
  referral: '<circle cx="8" cy="8" r="3"/><circle cx="17" cy="9" r="2.5"/><path d="M2 20a6 6 0 0 1 12 0M14 15a5 5 0 0 1 7 4"/>',
  ...
  command: '<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/><path d="M12 2v4m0 12v4M2 12h4m12 0h4"/>',
  mission: '<path d="M6 4h12v17H6z"/><path d="M9 4V2h6v2M9 9l2 2 4-4M9 16h6"/>',
