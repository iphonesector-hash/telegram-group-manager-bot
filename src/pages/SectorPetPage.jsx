...
export default function SectorPetPage(){
  ...
  var [data,setData]=useState(null),[busy,setBusy]=useState(''),[newName,setNewName]=useState('')
  ...
  return <div className="page fade-up">
    ...
    <div className="glass" style={{padding:12,marginTop:10,fontSize:10,color:'var(--muted)',lineHeight:1.9}}>🤝 برای گفت‌وگو، بازی دونفره و عملیات بانکی از دکمه «سکتور کوچولو» در چت ربات استفاده کن. انیمیشن تاس و دستگاه شانس داخل تلگرام اجرا می‌شود.</div>
