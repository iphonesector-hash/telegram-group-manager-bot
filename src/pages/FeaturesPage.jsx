...
var FEATURES = [
  {icon:'🤖',title:'دستیار هوشمند',desc:'پرسش و پاسخ فارسی با Sector AI',action:'tools'},
  ...
  {icon:'🌤️',title:'آب‌وهوا و ابزارها',desc:'هواشناسی، ترجمه، ماشین‌حساب و تبدیل واحد',action:'tools'},
